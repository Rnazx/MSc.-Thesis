...
kpc_r_cl = kpc_r_Claude * kpc_D_M31_Plot / kpc_D_M31_Chemin  #correct to distance used for our plots
...
dat_sigmatot = griddata(kpc_r_cl, Msunpc2_SigmaTot*g_Msun/(pcm)**2, kpc_r, method='linear', fill_value=nan, rescale=False)
dat_sigma = griddata(kpc_r_f, Msunpc2_SigmaHI_f*g_Msun/(pcm)**2, kpc_r, method='linear', fill_value=nan, rescale=False)
...
dat_q = griddata(kpc_r_f, dat_q, kpc_r, method='linear', fill_value=nan, rescale=False)
dat_omega = griddata(kpc_r_f, dat_omega, kpc_r, method='linear', fill_value=nan, rescale=False)
