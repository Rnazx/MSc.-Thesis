...
# distances_Mpc=[0.78,0.78,0.78,0.78,0.78,0.78,0.780,0.780,0.78,0.78]
...
# inclinations=[i_m31,i_m31,i_m31,i_m31,i_m31,i_m31,i_m31,i_m31,i_m31,i_m31] #used i_m31 as no inclination correction is needed for Claude data
...
# distances_Mpc=[0.785,0.785,0.785,0.785,0.785,0.785,0.780,0.780,0.785,0.785]
# r_col_names=['r kpc','r arcmin','r kpc','r arcmin','r arcmin','r kpc','r kpc','r arcmin','r arcsec','r arcsec']
# radius_conv_corr=[distance_m31/distances_Mpc[0],(1/(arcmin_deg*deg_rad))*(distance_m31*1000),distance_m31/distances_Mpc[2],(1/(arcmin_deg*deg_rad))*(distance_m31*1000),(1/(arcmin_deg*deg_rad))*(distance_m31*1000),distance_m31/distances_Mpc[5],distance_m31/distances_Mpc[6],(1/(arcmin_deg*deg_rad))*(distance_m31*1000),(1/(60*arcmin_deg*deg_rad))*(distance_m31*1000),(1/(60*arcmin_deg*deg_rad))*(distance_m31*1000)]
