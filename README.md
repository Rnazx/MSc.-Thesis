...
The expression for $u$ as a function of h obtained in Step 1 is used in the equation above, giving us a polynomial equation in h. We now solve for this polynomial numerically to obtain h as a function of only the observables. This solution is now used in the expressions for the turbulence parameters obtained in Step 1 (the light blue rhombuses) to obtain the turbulence parameters as a function of only the observables. We use Scipy's fsolve routine to find the root numerically. 
